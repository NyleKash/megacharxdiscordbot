		...
		if (content.startsWith(pre)) {
			...
			//else if (Values.isAdmin(event.getAuthor())) {
				...
				if (content.startsWith("prefix ")) {
					...
					String out = "The opposing command used stone edge! It was super effecticce! Critical hit! Mega Charizard X has fainted! You rush it to the nearest Pok�mon Center...";
					MessageChannel channel = event.getChannel();
			        channel.sendMessage(out).queue();
					System.exit(0);
				}
